...
const Login = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (username === 'admin@playplates.com' && password === 'harshit14012006') {
            ...
            // You can set token/user in localStorage and redirect here
            localStorage.setItem('user', JSON.stringify({ username, role: 'admin' }));
            navigate('/admin-dashboard'); // optional if using React Router
        } else {
    ...
    return (
        <div className="bg-black text-white flex min-h-screen flex-col items-center pt-16 sm:justify-center sm:pt-0">
            <a href="#" className="text-foreground font-semibold text-2xl tracking-tighter mx-auto flex items-center gap-2">
                    ...
                    <div className="p-6 pt-0">
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mt-4 flex items-center justify-between">
                                ...
                                <a className="text-sm font-medium text-white underline" href="/forgot-password">
                                    Forgot password?
                                </a>
                            </div>
